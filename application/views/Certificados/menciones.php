<div class="content-wrapper">
    <section class="content-header">
        ...
        <ol class="add-buttons">
            <li>
                <a class="btn btn-primary btn-flat crear" title="Registrar Mención" type="button" href="<?= base_url() ?>certificados/mencion_crear">
                    <span class="fa fa-plus"></span> Registrar Mención
                </a>
            </li>
        </ol>
    </section>
