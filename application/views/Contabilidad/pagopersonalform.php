<div class="content-wrapper">
    <section class="content">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <!-- http://localhost/carip_actualizacion/Contabilidad/getcomisiones/26 = id_uduario -->

                <?= form_open(base_url() . 'Contabilidad/pagopersonal_guardar/' . $usuario->usua_id, ['id' => 'form-1']); ?>
                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6 col-md-3">
                            ...
                            <?= form_input(array('name' => 'mes', 'id' => 'mes_pagar', 'class' => 'form-control', 'type' => 'month', 'value' => $pagopersonal->mes)) ?>
                        </div>
                </fieldset>
                                ...
                                <?php if($usuario->usua_tipo == 5):?>
                                    ...
                                    <tr class="<?= $usuario->usua_tipo != 5 ? 'hidden' : '' ?>">
                                        ...
                                        <td><label for="horas">Horas Dictadas:</label>
                                            <?= form_input(array('name' => 'horas[]', 'class' => 'form-control horas-cant', 'type' => 'number', 'min' => 0, 'value' => $pagopersonal->horas)) ?></td>
                                        <td><label for="costohora">Costo por Hora:</label>
                                            <?= form_input(array('name' => 'costohora[]', 'class' => 'form-control costo-hora', 'type' => 'number', 'min' => 0,  'value' => $pagopersonal->costohora)) ?></td>
                                        <td>
                ...
                <div class="form-group">
                    <button type="submit" value="Guardar" class="btn btn-success btn-block btn-sm">
                        <span class="glyphicon glyphicon-floppy-disk" aria-hidden="true"></span> Registrar Pago
                    </button>
                </div>
                <?= form_close() ?>
            </div>
