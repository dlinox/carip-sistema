<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="add-buttons">
      <li>
        <a class="btn btn-primary btn-flat crear" title="Registrar Tipo Alumno" type="button" href="<?= base_url() ?>configuracion/tipo_alumno_crear">
          <span class="fa fa-plus"></span> Registrar Tipo Alumno
        </a>
      </li>
    </ol>
