<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="add-buttons">
      <li>
        <a class="btn btn-primary btn-flat crear" title="Registrar Categoria" type="button" href="<?= base_url() ?>configuracion/categoria_crear">
          <span class="fa fa-plus"></span> Registrar Categoria
        </a>
      </li>
    </ol>
  </section>
