<div class="content-wrapper">
  <section class="content-header">
    ...
    <ol class="add-buttons">
      <li>
        <a class="btn btn-primary btn-flat crear" title="Registrar rubro" type="button" href="<?= base_url() ?>configuracion/rubro_crear">
          <span class="fa fa-plus"></span> Registrar rubro
        </a>
      </li>
    </ol>
