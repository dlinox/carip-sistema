...
$(document).ready(function(){
    ...
    function botones(id, $ar) {
        html = `
        <a href='{baseurl}configuracion/rubro_crear/{id}' title="Editar rubro" class="btn btn-primary btn-sm editar"><i class="fa fa-edit"></i></a>
        <a href='{baseurl}configuracion/rubro_eliminar/{id}'title="Eliminar rubro" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
