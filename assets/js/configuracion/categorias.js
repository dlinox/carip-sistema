...
$(document).ready(function(){
    ...
    function botones(id, $ar) {
        html = `
        <a href='{baseurl}configuracion/categoria_crear/{id}' title="Editar producto" class="btn btn-primary btn-sm editar"><i class="fa fa-edit"></i></a>
        <a href='{baseurl}configuracion/categoria_eliminar/{id}'title="Eliminar producto" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
