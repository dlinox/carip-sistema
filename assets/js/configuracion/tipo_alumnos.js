...
$(document).ready(function(){
    ...
    function botones(id, $ar) {
        html = `
        <a href='{baseurl}configuracion/tipo_alumno_crear/{id}' title="Editar tipo alumno" class="btn btn-primary btn-sm editar"><i class="fa fa-edit"></i></a>
        <a href='{baseurl}configuracion/tipo_alumno_eliminar/{id}'title="Eliminar tipo alumno" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
