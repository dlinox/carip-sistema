...
$(document).ready(function () {
  ...
  function botones(id, $ar) {
    html = `
        <a href='{baseurl}certificados/categoria_crear/{id}' title="Editar Categoria" class="btn btn-primary btn-sm editar"><i class="fa fa-edit"></i></a>
        <a href='{baseurl}certificados/categoria_eliminar/{id}'title="Eliminar Categoria" class="btn btn-danger btn-sm eliminar"><i class="fa fa-trash"></i></a>`;
